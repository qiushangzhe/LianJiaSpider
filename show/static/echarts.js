...
define('echarts/component/axisPointer', ['require', '../echarts', './axisPointer/modelHelper', './axisPointer/axisTrigger', 'zrender/core/util', './axisPointer/AxisPointerModel', './axisPointer/AxisPointerView', './axisPointer/CartesianAxisPointer'], function (require) {
    ...
    echarts.registerAction({
        ...
        var outputFinder = axisTrigger(ecModel.getComponent('axisPointer').coordSysAxesInfo, payload.currTrigger, [
                payload.x,
                payload.y
            ], payload, payload.dispatchAction || zrUtil.bind(api.dispatchAction, api), ecModel, api, payload.tooltipOption, payload.highDownKey);
        return outputFinder;
    });
});
...
define('echarts/component/tooltip/TooltipView', ['require', './TooltipContent', 'zrender/core/util', '../../util/format', '../../util/number', '../axisPointer/findPointFromSeries', '../../util/layout', 'zrender/core/env', '../../model/Model', '../axisPointer/globalListener', '../../coord/axisHelper', '../axisPointer/viewHelper', '../../echarts'], function (require) {
    ...
    require('../../echarts').extendComponentView({
        ...
        _updatePosition: function (tooltipModel, positionExpr, x, y, content, params, el) {
            ...
            if (zrUtil.isArray(positionExpr)) {
                ...
                var pos = refixTooltipPosition(x, y, content.el, viewWidth, viewHeight, align ? 0 : 20, vAlign ? 0 : 20);
                x = pos[0];
                y = pos[1];
            }
...
define('echarts/component/axisPointer/AxisPointerModel', ['require', '../../echarts'], function (require) {
    ...
    var AxisPointerModel = echarts.extendComponentModel({
            ...
            defaultOption: {
                ...
                handle: {
                    show: false,
                    icon: 'M10.7,11.9v-1.3H9.3v1.3c-4.9,0.3-8.8,4.4-8.8,9.4c0,5,3.9,9.1,8.8,9.4h1.3c4.9-0.3,8.8-4.4,8.8-9.4C19.5,16.3,15.6,12.2,10.7,11.9z M13.3,24.4H6.7V23h6.6V24.4z M13.3,19.6H6.7v-1.4h6.6V19.6z',
                    size: 45,
                    margin: 50,
                    color: '#333',
                    shadowBlur: 3,
    ...
    function buildPayloadsBySeries(value, axisInfo) {
        ...
        each(axisInfo.seriesModels, function (series, idx) {
            ...
            if (series.getAxisTooltipData) {
                ...
                dataIndices = series.getData().indexOfNearest(dataDim[0], value, false, axis.type === 'category' ? 0.5 : null);
